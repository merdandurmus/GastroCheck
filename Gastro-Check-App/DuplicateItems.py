...
# Example usage
parent_folder = "GastroCheck/Data/Training/TRAINING_NewModel_GastroBroncho_Colours_Pattern_7sites"  # Replace with the actual path to your "Training_Images" folder
